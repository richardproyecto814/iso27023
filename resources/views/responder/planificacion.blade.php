                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-16">
                                ...
                                <h3 class="title-5 m-b-35">ISO 27032 -> RESPONDER </h3>
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <select class="js-select2" name="property">
                                                ...
                                                <option value="">Planificación de la Respuesta (RS.RP)</option>
                                                <option value="">Comunicaciones (RS.CO)</option>
                                                <option value="">Análisis (RS.AN)</option>
                                                <option value="">Mitigación (RS.MI)</option>
                                                <option value="">Mejoras (RS.IM)</option>
