                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>RECUPERAR (RC)</td>
                                                <td>
                                                    <span class="block-email">Comunicaciones (RC.CO)</span>
                                                </td>
                                                <td class="desc">RC.CO-1: Se gestionan las relaciones públicas.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                            ...
                                            <tr class="tr-shadow">
                                               <td>
                                                ...
                                                <td class="desc">RC.CO-2: La reputación se repara después de un incidente.</td>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">RC.CO-3: Las actividades de recuperación se comunican a las partes interesadas internas y externas, así como también a los equipos ejecutivos y de administración.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
