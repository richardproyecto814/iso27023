                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company" placeholder="Ingrese su Nombre" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Apellidos</label>
                                            <input type="text" id="vat" placeholder="Ingrese su Apellido" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Cedula</label>
                                            <input type="text" id="street" placeholder="Ingrese su numero de Identificacion" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="hf-password" class=" form-control-label">Contraseña</label>
                                                    <input type="text" id="hf-password" placeholder="Contraseña" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="hf-password" class=" form-control-label">Repetir Contraseña</label>
                                            <input type="text" id="hf-password" placeholder="Repetir Contraseña" class="form-control">
                                        </div>
                                    </div>
