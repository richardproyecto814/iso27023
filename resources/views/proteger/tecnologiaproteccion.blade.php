                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-16">
                                ...
                                <h3 class="title-5 m-b-35">ISO 27032 -> PROTEGER  </h3>
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <select class="js-select2" name="property">
                                                ...
                                                <option value="">Seguridad de los datos (PR.DS)</option>
                                                <option value="">Procesos y procedimientos de protección de la información (PR.IP)</option>
                                                <option value="">Mantenimiento (PR.MA)</option>
                                                <option value="">Tecnología de protección (PR.PT)</option>
                                            </select>
