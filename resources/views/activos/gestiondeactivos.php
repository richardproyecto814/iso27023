                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-16">
                                ...
                                <h3 class="title-5 m-b-35">ISO 27032 -> ACTIVOS</h3>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">Los sistemas de información externos están catalogados.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">Los requisitos de resiliencia para respaldar la entrega de servicios críticos se establecen para todos los estados operativos (p. ej. bajo coacción o ataque, durante la recuperación y operaciones normales).</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
