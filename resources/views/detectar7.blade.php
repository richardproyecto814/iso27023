									...
									<div class="default-tab" >
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td> DETECTAR (DE) </td>
                                                <td>
                                                    <span class="block-email">Anomalías y Eventos (DE.AE)</span>
                                                </td>
                                                <td class="desc">DE.AE-1: Se establece y se gestiona una base de referencia para operaciones de red y flujos de datos esperados para</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            ...
                                            <tr class="tr-shadow">
                                               <td>
                                                ...
                                                <td class="desc">DE.AE-2: Se analizan los eventos detectados para comprender los objetivos y métodos de ataque.</td>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.AE-3: Cos datos de los eventos se recopilan y se correlacionan de múltiples fuentes y sensores.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.AE-4: Se determina el impacto de los eventos.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.AE-5: Se establecen umbrales de alerta de incidentes.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>DETECTAR (DE)</td>
                                                <td>
                                                    <span class="block-email">Monitoreo Continuo de la Seguridad (DE.CM)</span>
                                                </td>
                                                <td class="desc">DE.CM-1: Se monitorea la red para detectar posibles eventos de seguridad cibernética.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                               <td>
                                                ...
                                                <td class="desc">DE.CM-2: Se monitorea el entorno físico para detectar posibles eventos de seguridad cibernética.</td>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.CM-3: Se monitorea la actividad del personal para detectar posibles eventos de seguridad cibernética.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.CM-4: Se detecta el código malicioso.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.CM-5: Se detecta el código móvil no autorizado.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.CM-6: Se monitorea la actividad de los proveedores de servicios externos para detectar posibles eventos de seguridad cibernética.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.CM-7: Se realiza el monitoreo del personal, conexiones, dispositivos y software no autorizados.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.CM-8: Se realizan escaneos de vulnerabilidades.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>DETECTAR (DE)</td>
                                                <td>
                                                    <span class="block-email">Procesos de Detección (DE.DP)</span>
                                                </td>
                                                <td class="desc">DE.DP-1: Los roles y los deberes de detección están bien definidos para asegurar la responsabilidad.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                               <td>
                                                ...
                                                <td class="desc">DE.DP-2: Las actividades de detección cumplen con todos los requisitos aplicables.</td>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.DP-3: Se prueban los procesos de detección.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.DP-4: Se comunica la información de la detección de eventos.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">DE.DP-5: los procesos de detección se mejoran continuamente.</td>
                                                <td>
                                                <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Rango</option>
